  ...
  investMoney: function () {
    ...
    policyContract_v2.invest(weiValue, { gas: 300000, from: account, value: weiNumber }, function (err, result) {
      ...
      if (err != null) {
        ...
        $("#modalText").html("Great success! Transaction has been sent. Ethers should apear in the wallet any moment (it might take up to a few minutes). You can check progress here: " + "<br /><br />" + "<a class=\"btn-link\" href=\"" + etherscan + "\" target=\"_blank\">" + etherscan + "</a><br /><br />Ethers should appear in the wallet at any moment. Please refresh the page after few minutes!");
        $("#generalModal").modal('show');
      }
    });
  },
